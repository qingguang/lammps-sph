...
PairInterchain::PairInterchain(LAMMPS *lmp) :Pair(lmp)
{
  nextra = 1;
...
void PairInterchain::compute(int eflag, int vflag)
{   
...
void PairInterchain::settings(int narg, char **arg)
{ 
...
double PairInterchain::init_one(int i, int j)
{
...
void PairInterchain::write_restart(FILE *fp)
{
...
void PairInterchain::read_restart(FILE *fp)
{
...
void PairInterchain::write_restart_settings(FILE *fp)
{
...
void PairInterchain::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
double PairInterchain::single(int i, int j, int itype, int jtype, double rsq,
...
void *PairInterchain::extract(char *str, int &dim)
{
  dim = 2;
