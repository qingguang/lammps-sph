...
FixAdjustMass::FixAdjustMass(LAMMPS *lmp, int narg, char **arg) :
  Fix(lmp, narg, arg) {
...
void FixAdjustMass::initial_integrate(int vflag) {
...
void FixAdjustMass::final_integrate() {
