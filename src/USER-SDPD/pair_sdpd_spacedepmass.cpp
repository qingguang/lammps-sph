...
#include "string.h"
#include "pair_sdpd.h"
#include "pair_sdpd_spacedepmass.h"
...
void PairSDPDSpaceDepMass::init_style()
{
...
PairSDPDSpaceDepMass::PairSDPDSpaceDepMass(LAMMPS *lmp) :
  Pair(lmp), 
...
PairSDPDSpaceDepMass::~PairSDPDSpaceDepMass() {
  if (allocated) {
...
void PairSDPDSpaceDepMass::compute(int eflag, int vflag) {
...
/* ----------------------------------------------------------------------
   allocate all arrays
   ------------------------------------------------------------------------- */
void PairSDPDSpaceDepMass::allocate() {
  allocated = 1;
  int n = atom->ntypes;
...
/* ----------------------------------------------------------------------
   global settings
   ------------------------------------------------------------------------- */
void PairSDPDSpaceDepMass::settings(int narg, char **arg) {
  if (narg != 0)
    error->all(FLERR,
...
/* ----------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
void PairSDPDSpaceDepMass::coeff(int narg, char **arg) {
  if (narg != 10)
    error->all(FLERR,
...
double PairSDPDSpaceDepMass::init_one(int i, int j) {
...
double PairSDPDSpaceDepMass::single(int i, int j, int itype, int jtype,
                        double rsq, double factor_coul, double factor_lj, double &fforce) {
  std::cerr << "PairSDPDSpaceDepMass:single is called" << std::endl;
  fforce = 0.0;
  return 0.0;
}
...
void PairSDPDSpaceDepMass::ev_tally_sdpd(int i, int j, int nlocal, int newton_pair,
