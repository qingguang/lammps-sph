...
plot [0:10] \
     ...
     v=450, type=4, \
     nb=0,  ns=20,  f(nb, ns, v) w l lw 3 lc 1 lt type t sprintf("v = %4.0f, c_p = %3.0f\%", v, 100*(nb+0.0)/(nb+ns)), \
     nb=10, ns=20,  f(nb, ns, v) w l lw 3 lc 2 lt type t sprintf("v = %4.0f, c_p = %3.0f\%", v, 100*(nb+0.0)/(nb+ns)), \
     nb=10, ns=5, f(nb, ns, v) w l lw 3 lc 3 lt type t sprintf("v = %4.0f, c_p = %3.0f\%", v,  100*(nb+0.0)/(nb+ns))
